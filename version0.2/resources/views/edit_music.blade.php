       ...
       <!-- page content starts here -->     
        ...
        <div class="box" style="border:none">
          <div class="box-content">
                <form class="form-horizontal edit-event"  method="post" action="{{route('update-music')}}" enctype="multipart/form-data">
                    {{ csrf_field()}} 
                    <div class="box-body">
                        <div class="form-group">
                            <label >Music Name:<span class="required"> * </span></label>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="MusicName" id="EventName" value="{{$music->MusicName}}">
                            <input type="hidden" name="latitude" id="latitude">
                            <input type="hidden" name="longitude" id="longitude">
                            <input type="hidden" class="form-control" name="id" id="id" value="{{$music->id}}">
                        </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label >Select Music Start Date:<span class="required"> * </span></label>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control input-calendar" name="StartDate" value="{{$music->StartDate}}">
                        </div>
                    </div>
...
{{--                     <div class="box-body">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label >Select music Start Time:<span class="required"> * </span></label>
                        </div>
                        <div class="form-group">
                                <input type="text" name="StartTime" class="form-control timepicker" id="eventStartTime" value="{{$music->StartTime}}"/>
                        </div>
                    </div>

                    <div class="box-body">
                        <div class="form-group">
                            <label >Select Music End Time:<span class="required"> * </span></label>
                        </div>
                        <div class="form-group">
                                <input type="text" name="EndTime" class="form-control timepicker" id="musicEndTime" value="{{$music->EndTime}}"/>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" id="Venu" name="venue" style="height:100px;">{{$music->venue}}</textarea>
                        </div>
                    </div>

                    <div class="box-body">
                        <div class="form-group">
                            <label >About Music:</label>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" name="AboutMusic" style="height:100px;">{{$music->AboutMusic}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="Organizer" style="height:100px;">{{$music->Organizer}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="BuyTicketURL" style="height:100px;">{{$music->BuyTicketURL}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="BannerImg" type="file" value="{{$music->BannerImg}}">
                        </div>

                        <div class="form-group">
                        	<input type="hidden" name="oldBannerImg" value="{{$music->BannerImg}}">
                            <img src="{{URL::asset('images/'.$music->BannerImg)}}" style="width:400px;height:200px">
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                        	<input type="hidden" name="oldOrganizerImg" value="{{$music->OrganizerImg}}">
                            <img src="{{URL::asset('images/'.$music->OrganizerImg)}}" >
                        </div>
                    </div>
