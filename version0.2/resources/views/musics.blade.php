  ...
  <div class="content-wrapper">
    <section class="content container-fluid">
        ...
        <div class="content-header content-header2" >
           <h1 style="float:left;">View Musics</h1>

            <span class="search-controls" style="float:right;">
             
             <a href="{{url('add_music')}}" class="btn btn-default fill"> Add Music </a>
            </span>
        </div>
            ...
            <div class="box-body" style="overflow-x:scroll">
              ...
              <table id="example1" class="table table-responsive no-padding video-list1" style="overflow-x:scroll;">
                ...
                <tr>
                  ...
                  <td>
                    @if(strlen($d->AboutMusic) < 50)
                    {{ strip_tags($d->AboutMusic)}}
                    @else
                    {{(substr(strip_tags($d->AboutMusic), 0, 50))}}...
                    @endif
                    </td>
          ...
          <div class="modal fade" id="delete{{$d->id }}" tabindex="-1"  aria-hidden="true" role="basic">
              <div class="modal-dialog modal-sm">
                <div class="modal-content">
                  ...
                  <form action="{{route('delete-music')}}" method="post">
                  {{csrf_field() }}
                      <div class="modal-body"> Are you want delete the music. </div>
