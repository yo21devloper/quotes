       ...
       <!-- page content starts here -->     
        ...
        <div class="box" style="border:none">
          <div class="box-content">
                <form class="form-horizontal edit-services"  method="post" action="{{route('submit_tutor')}}" enctype="multipart/form-data">
                    {{ csrf_field()}} 
                    <div class="box-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                                 ...
                                 <select class="form-control" name="Major" id="Major">
                                                    ...
                                                    <option value=''> -- Please Select the Major --</option>
                                                    @foreach($data as $d)
                                                    <option value="{{$d->id}}">{{$d->Major}}</option>
                                                    @endforeach
                                                  </select>
                        </div>
                    </div>
