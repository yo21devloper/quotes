       ...
       <!-- page content starts here -->     
        ...
        <div class="box" style="border:none">
          <div class="box-content">
                <form class="form-horizontal edit-services add-event"  method="post" action="{{route('submit_music')}}" enctype="multipart/form-data">
                    {{ csrf_field()}} 
                    <div class="box-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="AboutMusic" required="" style="height:100px;"></textarea>
                        </div>
                    </div>
